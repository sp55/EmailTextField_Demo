...
@interface EmailTextField ()<UITableViewDataSource, UITableViewDelegate>
...
//    PromptTableViewCell *cell = [self.promptTableView dequeueReusableCellWithIdentifier:@"promptCell" forIndexPath:indexPath];
    ...
    if (!cell) {
        cell=[[PromptTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"cell"];
    }
